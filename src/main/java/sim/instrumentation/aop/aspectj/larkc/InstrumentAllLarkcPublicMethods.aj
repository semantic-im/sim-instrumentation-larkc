 ...
 *
 */
public aspect InstrumentAllLarkcPublicMethods extends AbstractMethodInstrumentation {

	public pointcut methodsToInstrument(): within(eu.larkc..*) && execution(public * *(..));
